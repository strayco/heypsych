        ...
        <div className="space-y-6">
          {items.map((item, i) => (
            <div key={i} className="border-b border-separator pb-6 last:border-b-0 last:pb-0">
              <h4 className="mb-2 font-semibold text-label-primary"><ParsedContent content={item.feature} /></h4>
              <p className="mb-2 text-sm text-label-primary"><ParsedContent content={item.description} /></p>
              {item.evidence && (
                <div className="rounded-lg border border-purple-200 bg-purple-50 px-3 py-2">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-xs text-purple-900">
                      ...
                      <ParsedContent content={item.evidence} />
                    </p>
                  </div>
                </div>
              )}
