...
export default function CategoryPage() {
  const { data: conditions, isLoading, error } = useConditionsByCategory("personality-disorders");
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gray-50">
        <div className="space-y-4 text-center">
          <div className="mx-auto h-8 w-8 animate-spin rounded-full border-4 border-slate-500 border-t-transparent"></div>
          ...
          <Card className="rounded-3xl bg-white shadow-xl">
            <CardHeader>
              <CardTitle className="text-center text-2xl font-bold text-slate-900">
                All Personality Disorders Conditions
              </CardTitle>
            </CardHeader>
                    ...
                    return (
                      ...
                      >
                        <motion.div
                          ...
                          className="rounded-xl border border-slate-200 p-6 transition-all duration-300 group-hover:bg-slate-50 hover:border-slate-300 hover:shadow-md"
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                <h3 className="text-lg font-semibold text-slate-900 transition-colors group-hover:text-slate-600">
                                  {conditionName}
                                </h3>
                            ...
                            <ArrowRight className="h-5 w-5 text-slate-400 transition-all group-hover:translate-x-1 group-hover:text-slate-500" />
                          </div>
                        </motion.div>
                      </Link>
                    );
                ...
                <div className="py-12 text-center">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-slate-400">
                      Looking for category: "personality-disorders"
                    </p>
                    <p className="text-xs text-slate-400">
