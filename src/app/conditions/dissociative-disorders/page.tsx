 ...
 * Includes complete SEO metadata for dissociative-disorders hub page
 */

const fullCategoryConfig = getCategoryBySlug("dissociative-disorders")!;
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${SITE_CONFIG.url}/conditions/dissociative-disorders`,
  },
  openGraph: {
    title: `${categoryConfig.displayTitle} | HeyPsych`,
    description: categoryConfig.description,
    url: `${SITE_CONFIG.url}/conditions/dissociative-disorders`,
    type: "website",
...
export default async function DissociativeDisordersPage() {
  const conditions = await getConditionsByCategoryServer("dissociative-disorders");
