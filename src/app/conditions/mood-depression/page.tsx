...
export default function CategoryPage() {
  const { data: conditions, isLoading, error } = useConditionsByCategory("mood-depression");
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-8 flex items-start justify-between">
            ...
            <div className="flex-1 text-center">
              ...
              <h1 className="mb-4 bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 bg-clip-text text-3xl font-bold text-transparent sm:text-4xl lg:text-5xl">
          ...
          <Card className="rounded-3xl bg-white shadow-xl">
            <CardHeader>
              <CardTitle className="text-center text-2xl font-bold text-slate-900">
                All Mood & Depression Conditions
              </CardTitle>
            </CardHeader>
                    ...
                    return (
                      ...
                      >
                        <motion.div
                          ...
                          className="rounded-xl border border-slate-200 p-6 transition-all duration-300 group-hover:bg-blue-50 hover:border-blue-300 hover:shadow-md"
                        >
                ...
                <div className="py-12 text-center">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-slate-400">
                      Looking for category: "mood-depression"
                    </p>
                    <p className="text-xs text-slate-400">
