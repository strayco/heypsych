...
import { ArrowLeft, Puzzle, Brain, ArrowRight } from "lucide-react";
...
export default function CategoryPage() {
  const { data: conditions, isLoading, error } = useConditionsByCategory("autism-development");
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-8 flex items-start justify-between">
            ...
            <div className="flex-1 text-center">
              ...
              <h1 className="mb-4 bg-gradient-to-r from-slate-900 via-emerald-900 to-slate-900 bg-clip-text text-3xl font-bold text-transparent sm:text-4xl lg:text-5xl">
          ...
          <Card className="rounded-3xl bg-white shadow-xl">
            <CardHeader>
              <CardTitle className="text-center text-2xl font-bold text-slate-900">
                All Autism & Development Conditions
              </CardTitle>
            </CardHeader>
            <CardContent className="p-8">
              {conditions && conditions.length > 0 ? (
                    ...
                    return (
                      ...
                      >
                        <motion.div
                          ...
                          className="rounded-xl border border-slate-200 p-6 transition-all duration-300 group-hover:bg-emerald-50 hover:border-emerald-300 hover:shadow-md"
                        >
                          <div className="flex items-center justify-between">
                            ...
                            <ArrowRight className="h-5 w-5 text-slate-400 transition-all group-hover:translate-x-1 group-hover:text-emerald-500" />
                          </div>
                        </motion.div>
                      </Link>
                    );
                ...
                <div className="py-12 text-center">
                  <Puzzle className="mx-auto mb-4 h-16 w-16 text-slate-300" />
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-slate-400">
                      Looking for category: "autism-development"
                    </p>
                    <p className="text-xs text-slate-400">
