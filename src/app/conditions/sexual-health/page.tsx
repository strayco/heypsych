 ...
 * Includes complete SEO metadata for sexual-health hub page
 */

const fullCategoryConfig = getCategoryBySlug("sexual-health")!;
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${SITE_CONFIG.url}/conditions/sexual-health`,
  },
  openGraph: {
    title: `${categoryConfig.displayTitle} | HeyPsych`,
    description: categoryConfig.description,
    url: `${SITE_CONFIG.url}/conditions/sexual-health`,
    type: "website",
...
export default async function SexualHealthPage() {
  const conditions = await getConditionsByCategoryServer("sexual-health");
