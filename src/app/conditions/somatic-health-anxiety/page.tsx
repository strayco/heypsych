 ...
 * Includes complete SEO metadata for somatic-health-anxiety hub page
 */

const fullCategoryConfig = getCategoryBySlug("somatic-health-anxiety")!;
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${SITE_CONFIG.url}/conditions/somatic-health-anxiety`,
  },
  openGraph: {
    title: `${categoryConfig.displayTitle} | HeyPsych`,
    description: categoryConfig.description,
    url: `${SITE_CONFIG.url}/conditions/somatic-health-anxiety`,
    type: "website",
...
export default async function SomaticHealthAnxietyPage() {
  const conditions = await getConditionsByCategoryServer("somatic-health-anxiety");
