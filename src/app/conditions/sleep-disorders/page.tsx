 ...
 * Includes complete SEO metadata for sleep-disorders hub page
 */

const fullCategoryConfig = getCategoryBySlug("sleep-disorders")!;
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${SITE_CONFIG.url}/conditions/sleep-disorders`,
  },
  openGraph: {
    title: `${categoryConfig.displayTitle} | HeyPsych`,
    description: categoryConfig.description,
    url: `${SITE_CONFIG.url}/conditions/sleep-disorders`,
    type: "website",
...
export default async function SleepDisordersPage() {
  const conditions = await getConditionsByCategoryServer("sleep-disorders");
