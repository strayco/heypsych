      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <div className="mt-6 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-white/30 bg-white/10 px-5 py-2.5 text-sm font-medium transition-colors hover:bg-white/20"
            style={{ color: '#ffffff' }}
          >
            Become a partner
          </Link>
