...
const PRACTICE_CONFIGS: Record<string, {
  ...
  "solo-therapist": {
    ...
    icon: User,
    color: "treatment",
    seoTitle: "Best Software for Solo Therapists (2026) | Practice Technology",
  ...
  "therapy-group": {
    ...
    icon: Users,
    color: "accent",
    seoTitle: "Best Software for Group Therapy Practices (2026)",
  ...
  "psychiatry": {
    ...
    icon: Stethoscope,
    color: "treatment",
    seoTitle: "Best EHR & Software for Psychiatrists (2026)",
  ...
  "telehealth-first": {
    ...
    icon: Video,
    color: "accent",
    seoTitle: "Best Software for Telehealth Therapy Practices (2026)",
  ...
  "iop-php": {
    ...
    icon: Building2,
    color: "treatment",
    seoTitle: "Best Software for IOP & PHP Programs (2026)",
  ...
  "psychological-testing": {
    ...
    icon: Brain,
    color: "accent",
    seoTitle: "Best Software for Psychological Testing Practices (2026)",
  ...
  "addiction-treatment": {
    ...
    icon: Heart,
    color: "treatment",
    seoTitle: "Best Software for Addiction Treatment Centers (2026)",
  ...
  "starting-out": {
    ...
    icon: Sparkles,
    color: "accent",
    seoTitle: "Software Checklist for Starting a Therapy Practice (2026)",
