// src/app/tools/for-clinicians/ai-scribes-documentation/page.tsx
// AI Scribes & Documentation Hub
...
const HUB_SLUG = "ai-scribes-documentation";
...
export default async function AIScribesDocumentationPage() {
  const hub = TaxonomyService.getClinicianHub(HUB_SLUG);
  if (!hub) {
    notFound();
  }
