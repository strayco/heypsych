// src/app/tools/for-clinicians/practice-admin-operations/page.tsx
// Practice Admin & Operations Hub
...
const HUB_SLUG = "practice-admin-operations";
...
export default async function PracticeAdminOperationsPage() {
  const hub = TaxonomyService.getClinicianHub(HUB_SLUG);
  if (!hub) {
    notFound();
  }
