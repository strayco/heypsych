// src/app/tools/for-clinicians/clinical-answers-evidence/page.tsx
// Clinical Answers & Evidence Hub
...
const HUB_SLUG = "clinical-answers-evidence";
...
export default async function ClinicalAnswersEvidencePage() {
  const hub = TaxonomyService.getClinicianHub(HUB_SLUG);
  if (!hub) {
    notFound();
  }
