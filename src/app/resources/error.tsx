...
export default function ResourcesError({
  ...
  useEffect(() => {
    logger.error("Resources page error", error);
  }, [error]);
    ...
    <div className="flex min-h-screen items-center justify-center bg-canvas p-4">
      <div className="w-full max-w-md rounded-xl border border-separator bg-surface-grouped p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h1 className="text-lg font-semibold text-label-primary">Error Loading Resources</h1>
        </div>
        <div className="space-y-4">
          <p className="text-sm text-label-tertiary">
            We encountered an error while loading the resources. Please try again.
          </p>
